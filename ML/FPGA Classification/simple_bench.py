...
ol = Overlay("/home/xilinx/model_v0.1.bit")


dma = ol.axi_dma_0


in_data = pd.read_csv("/home/xilinx/x_test_real.csv").to_numpy(dtype=np.float32)
in_label = pd.read_csv("/home/xilinx/y_test_real.csv").to_numpy(dtype=np.int64)


input_buffer = allocate(shape=(432,), dtype=np.float32)
...
for i in range(test_batch):
    input_buffer[:] = flat_data[i*432:432+i*432]
